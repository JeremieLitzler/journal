...
#      {
#        rel: canonical,
#        href: https://thetooltip.substack.com/p/installation-pv-9mois-part2,
#      },
#    ]
category:
  - Energie
...
- un [routeur solaire de Robin Emley](https://mk2pvrouter.co.uk/) (repris par [un couple français fin 2022](https://mk2pvrouter.com/)).
...
- L'installation solaire a vraiment aidé à diminuer la consommation du résaeau.
...
| 12    | 382,00  | 334,00  | 369,00  | 116,90  |
| Total | 2798,00 | 3019,00 | 2838,00 | 2799,40 |
...
Aussi, l'utilisation en journée de la plaque à induction au lieu de la cuisinière à gaz augmente la consommation électrique. Mais en été, c'est normal.
...
```json
{
  ...
  "series": [
    {
      "data": [
        0, 0, 17.3, 160.6, 210.4, 204.3, 225.4, 192.7, 150.9, 109.3, 62.6, 11.9
      ],
      "type": "line"
    },
    {
    ...
    {
      "data": [
        0, 0, 7.3, 147.6, 186.4, 183.3, 204.4, 154.7, 147.9, 108.3, 61.6, 11.9
      ],
      "type": "line"
    }
  ]
...
Si je prends le coût réel du kWh incluant l'abonnement mois par mois, j'arrive à un peu plus de 300 euros en 9 mois. Cela rentabilise déjà le routeur solaire !

Vu la performance des deux derniers mois, je ne suis pas sûr qu'il y ait un gain important dans les trois à venir.
...
Je me suis rendu sur [le site PVG](https://re.jrc.ec.europa.eu/pvg_tools/fr/#PVP) pour estimer la production technique, hors météo et ombre de la végétation avec les entrées suivantes :
...
Je ne sais pas quel calcul sera le plus juste.
...
- Trouver un moyen d'utiliser le déhydrateur sans chauffer la maison l'été.
  ...
  - Je pense à une rallonge qui courait de la sortie 2 du routeur à la véranda.
  - Pour y arriver, il y a de la distance à parcourir.
...
- Réduire la résistant du chauffe-eau en fonction de ce que l'hiver nous apprendra
  ...
  - Quelle sera la durée optimale de chauffe de l'ECS tout en gardant l'option de faire tourner une lessive ou le lave-vaisselle la même nuit.
