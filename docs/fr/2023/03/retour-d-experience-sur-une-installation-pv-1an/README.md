...
<!-- ![Production par mois d'avril 2022 à mars 2023](/images/2023-03-31-production-par-mois-avril2022-mars2023.jpg) -->

Fin Mars 2022, nous avons mis en service notre installation photovoltaïque. Regardons les données et les conclusions à la fin de la première année
...
Ce que je n’avais pas anticipé, c’est la température de l’eau du réseau.

L’été, elle arrive à 25°C donc pour monter l’eau à la température limite du thermostat du cumulus demande 20°C de moins à chauffer qu'en hiver.

Oui, en hiver, vous avez bien calculer : l’eau du réseau descend à 5°C.

Parfait pour des douches froides 🚿🥶. Mais ce n’est pas pour tout le monde, je l’avoue.

Du coup, quand le routeur donne 2kWh de surplus solaire au cumulus (pour une journée ensoleillée d'hiver), l’eau chauffe bien, mais pas assez pour mon épouse et les deux petites filles, qui aiment l’eau bien chaude.
...
En consommation du réseau pour chauffer l’eau chaude sanitaire (ECS), sur un an, on est passé 957 kWh sur l’année 2021 à 492 kWh sur l’année 2022.

Pour le moment, je n’ai pas de retour sur expérience assez conséquent pour dire s’il est possible d’optimiser sans dépenser des grosses sommes supplémentaires.

Encore une fois, notre orientation et le relief ne permettent pas d’installer et rentabiliser des panneaux solaires thermiques. En effet, le coût initiale est bien plus important et n’agit que sur le poste **_ECS_** alors qu’avec l’installation photovoltaïque, on agit sur tout ce qui consomme de l’électricité.
...
| Mars 2023      | 82,3       | 98,78%                  |
| **Total**      | **1593,1** | **94,13%**              |

L'utilisation du routeur solaire apporte vraiment un plus.

En effet, la plupart des sources que j'ai trouvé _rapportent que lissé sur l’année, le taux d’autoconsommation avoisine les 20 à 30 %. C’est-à-dire que 70 à 80 % de la production d’électricité solaire n’est pas utilisée pour alimenter la maison._
...
- entre 1155 kWh (autoconsommation à 30 %), soit ~238 euros (à 22.62[^source_edf] cts l'unité)
- et 1320 kWc (autoconsommation à 20 %), soit ~272 euros (à 22.62 cts l'unité)
...
En mars 2023, un kWh acheté (en heure creuse dans mon cas) à Enedis coûte environ 16 cts d'euros.

En partant du principe que le nombre de kWh non acheté sur un an correspond à la différence de l'année 2021 et de l'année 2022, on obtient 465 kWh.
...
La meilleur solution reste le routeur, mais il faut bien le choisir.
...
| Mois      | Consommation 2021 | Consommation 2022 | Consommation 2023 | Remarques                                                                              |
| --------- | ----------------- | ----------------- | ----------------- | -------------------------------------------------------------------------------------- |
| Janvier   | 320,00            | 417,00            | 205,00            | L’année 2022 avait été très important (sûrement le froid).                             |
| Février   | 295,00            | 100,00            | 185,00            | En 2023, on a consommé 85% de plus, mais nous étions présents qu’une semaine en 2022 ! |
| Mars      | 260,00            | 268,00            | 126,00            | On a dévisé par 2 sur le mois de mars, particulièrement bien ensoleillé.               |
| Avril     | 253,00            | 118,00            | à venir           | -                                                                                      |
| Mai       | 213,00            | 79,00             | à venir           | -                                                                                      |
| Juin      | 156,00            | 61,00             | à venir           | -                                                                                      |
| Juillet   | 82,00             | 51,00             | à venir           | -                                                                                      |
| Août      | 187,00            | 65,00             | à venir           | -                                                                                      |
| Septembre | 58,00             | 67,00             | à venir           | -                                                                                      |
| Octobre   | 347,00            | 78,00             | à venir           | -                                                                                      |
| Novembre  | 298,00            | 177,00            | à venir           | -                                                                                      |
| Décembre  | 369,00            | 228,00            | à venir           | -                                                                                      |
| Total     | 2838,00           | 1709,00           | à venir           | Attendrons-nous les 1500 kWh annuels ? C’est très possible.                            |

## Quelles sont les étapes suivantes

### Installation solaire secondaire avec batterie

Je dois toujours câbler les panneaux solaire de 240Wc pour les installer derrière ma maison.
...
Je ne pense pas réaliser cet usage tout l’année, mais j’aimerai prendre des mesures.

En effet, la batterie alimentera le réfrigérateur toute la journée. Mais avec les deux panneaux et la recharge de 400Wc pendant la journée devrait être largement suffisant pour recharger la consommation nocturne et apporter ce qu’il faut pour la journée.

Je suis d'accord qu'il n'est pas sûr que cela soit rentable, vu le prix de la batterie et la capacité que j’utilise (DOD entre 90% et 30%).
...
En fait, les champs, surtout celui du Sud, sont bien plus bas et donc les chats viennent sans problème marcher dessus.

Je dois aussi attacher le champ de panneau Sud-Ouest, car il y a eu un bon coup de vent il y a 15 jours et le champ a été déconnecté du reste.

Du coup, l’onduleur était en erreur.

J’ai réussi à remettre le tout en route rapidement.

En attendant le prochain rendez-vous (sûrement en fin d'année 2023), ==merci d'avoir lu cet article et merci pour votre soutien !==
